...
public class TeacherService implements ITeacherService {
    ...
    public Teacher updatedTeacherById(int id, Teacher toBeUpdatedTeacher){
        getTeacherById(id);
    ...
    private Teacher getTeacherById(int id){
        return repository.findById(id).orElseThrow(()-> new NoSuchElementException("Teacher is found in this id" + id));
    }
}
